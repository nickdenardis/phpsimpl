...
class Post extends DbTemplate {
     ...
     * @param DB $db_link
     */
	function __construct(DB $db_link) {

		// Call the parent constructor
		parent::__construct('post', $db_link);
...
class Author extends DbTemplate {
	...
	function __construct(DB $db_link){
		// Call the parent constructor
		parent::__construct('author', $db_link);
...
class Tag extends DbTemplate {
	...
	function __construct(DB $db_link){
		// Call the parent constructor
		parent::__construct('tag', $db_link);
...
class PostTag extends DbTemplate {
	...
	function __construct(DB $db_link){
		// Call the parent constructor
		parent::__construct('post_tag', $db_link);
