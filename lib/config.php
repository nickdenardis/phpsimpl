...
if (!defined('DB_SESSIONS')) {
    define('DB_SESSIONS', false);
}
// Enable the garbage collection of session each page load
if (!defined('DB_SESSIONS_GC')) {
    define('DB_SESSIONS_GC', true);
}
...
// Table Stripes
if (!defined('SIMPL_TABLE_STRIPES')) {
...
if (!defined('WS_SIMPL_IMAGE')) {
    define('WS_SIMPL_IMAGE', 'img/');
}
if (!defined('WS_SIMPL_INC')) {
    define('WS_SIMPL_INC', 'inc/');
}
if (!defined('WS_SIMPL_CSS')) {
    define('WS_SIMPL_CSS', 'css/');
}
if (!defined('WS_SIMPL_JS')) {
...
if (!defined('DB_USER')) {
    define('DB_USER', (defined('DBUSER'))?DBUSER:null);
}
if (!defined('DB_HOST')) {
    define('DB_HOST', (defined('DBHOST'))?DBHOST:null);
}
if (!defined('DB_PASS')) {
    define('DB_PASS', (defined('DBPASS'))?DBPASS:null);
}
